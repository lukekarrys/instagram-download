...
exports['default'] = function (options, cb) {
  ...
  (0, _async.series)({
    ...
    var imageQueue = (0, _async.queue)((0, _utilSaveFiles.saveImage)(queueOptions), _utilConstants.QUEUE_CONCURRENCY);

    // Fetch the first page of most recent media
    // The fetchAndSave callback will take care of iterating over each page
    ig.user_media_recent(user, igOptions, (0, _utilSaveFiles.fetchAndSave)({ jsonQueue: jsonQueue, imageQueue: imageQueue }, cb));
  });
};
